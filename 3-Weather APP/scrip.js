...
const final_date=`${month}-${current_date}-${current_date}:${minutes}`;
...
const get_feels_like_temp =(data)=>{
    ...
    feels_like_element.innerText=`Feels like temp: ${data.main.feels_like}C`
}
...
function get_pressure(data){
    ...
    pressure_element.innerText=`Pressure: ${data.main.pressure}Pa`
}
